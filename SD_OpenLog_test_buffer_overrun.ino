/*
 ...
 Nathan Seidle. This code is public domain but you buy me a beer if you use this and we meet someday (Beerware license).
...
{ 
  ...
  //Serial.begin(9600); //9600bps is default for OpenLog, 19200, 38400, 57600, 115200 supported
  ...
  int testAmt = 50;  //testAmt of 10 will push 111,000 characters/bytes. With header and footer strings, total is 111,052
  ...
  //Each test is 100 lines (11,000 characters). 10 tests is 1000 lines (110,000 characters? or 111k?)
